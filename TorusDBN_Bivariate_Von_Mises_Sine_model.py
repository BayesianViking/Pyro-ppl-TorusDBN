...
def main(args):
    ...
    priors_mu_nu = plot_data_provide_clusters(mask = lengths.int(), Dihedral_sequence = sequences, AA_train = train_AA, DSSP_train = train_DSSP,nr_clusters = args.nr_clusters, hidden_dims = args.hidden_dim)
